...
import com.beyond.zjxt.core.common.constant.DefaultAvatar;
...
import com.beyond.zjxt.modular.system.entity.Notice;
import com.beyond.zjxt.modular.system.entity.User;
import com.beyond.zjxt.modular.system.factory.UserFactory;
import com.beyond.zjxt.modular.system.service.FileInfoService;
import com.beyond.zjxt.modular.system.service.NoticeService;
...
public class SystemController extends BaseController {
    ...
    public String console() {
        List<Long> longList = ShiroKit.getUser().getRoleList();
        Long role = longList.get(0);

        //养护站经理
        Long yhzjl = 1201025605710802946L;
        //区县填报人员
        Long qxtbry = 15L;
        //区县部门领导
        Long qxbmld = 13L;
        ...
        Long qxzgld = 14L;
        //市级主管领导
        Long sjzgld = 1202130817007374338L;
        //市区部门领导
        Long sqbmld = 6L;
        //市级最高领导
        Long sjzuigaold = 1203672010841522177L;
        if (role.equals(yhzjl)) {
            return "/modular/system/patrolResult/patrolResult.html";
        }else if (role.equals(qxtbry)) {
            return "/modular/system/roadHazardList/roadHazardList.html";
        }else if (role.equals(qxbmld)) {
            return "/modular/system/countyFirstTrial/countyFirstTrial.html";
        }else if(role.equals(qxzgld) ) {
            return "/modular/system/countyFirstTrial/countyFirstTrial.html";
        }else if (role.equals(sjzgld)) {
            return "/modular/system/audit/city_Executive_under_audit.html";
        }else if (role.equals(sqbmld)) {
            return "/modular/system/audit/city_under_audit.html";
        }else if (role.equals(sjzuigaold)){
            return "/modular/system/patrolResultIssueList/allRoadHazardList.html";
        }else {
            return "/modular/frame/white.html";
        }
    }
