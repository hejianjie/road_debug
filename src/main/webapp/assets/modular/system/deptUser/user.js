layui.use(['layer', 'form', 'table', 'ztree', 'laydate', 'admin', 'ax'], function () {
    ...
    MgrUser.openAddUser = function () {
        ...
        top.layui.admin.open({
            type: 2,
            title: '添加用户',
            content: Feng.ctxPath + '/DeptUser/user_add',
            end: function () {
    ...
    MgrUser.onEditUser = function (data) {
        ...
        top.layui.admin.open({
            type: 2,
            title: '编辑用户',
            content: Feng.ctxPath + '/DeptUser/user_edit?userId=' + data.userId,
            end: function () {
                admin.getTempData('formOk') && table.reload(MgrUser.tableId);
            }
        });
    ...
    MgrUser.roleAssign = function (data) {
        layer.open({
            ...
            title: '角色分配',
            area: ['300px', '400px'],
            content: Feng.ctxPath + '/DeptUser/role_assign?userId=' + data.userId,
            end: function () {
                table.reload(MgrUser.tableId);
            }
        });
    ...
    var tableResult = table.render({
        ...
        url: Feng.ctxPath + '/DeptUser/list',
        page: true,
        height: "full-98",
        cellMinWidth: 100,
