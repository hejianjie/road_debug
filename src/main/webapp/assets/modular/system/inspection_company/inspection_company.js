layui.use(['layer', 'form', 'table', 'admin', 'ax','formSelects', 'laydate'], function () {
    ...
    ThirdParty.initColumn = function () {
        return [[
            ...
            {field: 'name', sort: true, title: '第三方核量公司名称'},
            {field: 'account', sort: true, title: '第三方核量公司账号'},
    ...
    ThirdParty.search = function () {
        ...
        table.render({
            ...
            url: Feng.ctxPath + '/inspectionCompany/getCompanyList?companyName='+title,
            page: true,
            height: "full-98",
            cellMinWidth: 100,
    ...
    var tableResult = table.render({
        elem: '#' + ThirdParty.tableId,
        url: Feng.ctxPath + '/inspectionCompany/getCompanyList',
        page: true,
        height: "full-98",
        cellMinWidth: 100,
        cols: ThirdParty.initColumn()
