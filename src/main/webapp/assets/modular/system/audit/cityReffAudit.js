        ...
        if (auditSuggestion==""){
            ...
            if (auditSuggestion != "同意") {
                if (comment == null || comment == "") {
                    ...
                    console.log("哈哈哈哈哈")
                    var ajax = new $ax(Feng.ctxPath + "/application/updateCityAuditResult?auditSuggestion=" + auditSuggestion + "&feedback=" + comment + "&applicationId=" + applicationId+"&reff=1", function () {
                        Feng.success("审核成功");
