layui.use(['table', 'admin', 'ax', 'ztree','laydate','form'], function () {
    ...
    CityAuditHistory.initColumn=function () {
        return [[
            ...
            {field: 'reffauditTime',  title: '审核时间'},
    ...
    CityAuditHistory.audit = function (data) {
        window.location.href=Feng.ctxPath+'/application/cityReffAudit?applicationId='+data.applicationId+'&audited=1';
    }

    // 渲染表格
    var tableResult = table.render({
        elem: '#' + CityAuditHistory.tableId,
        url: Feng.ctxPath + '/application/reffAuditHistoryList',
        page: true,
        limit:40,
        height: "full-98",
        cellMinWidth: 100,
